...
st.set_page_config(
    page_title="Корреляционный анализ показателей районов алтайского края",
    layout="wide",
...
def rename_columns(df):
    ...
    col_map = {
        ...
        "работниковСх": "Совершивших_преступления_работников_сельского_хозяйства",
        ...
        "обучающиеся": "Обучающиеся_всего",
        "челСПО": "Обучающиеся_СПО",
        "принятоСПО": "Принято_на_СПО",
        "выпущеноСПО": "Выпущено_из_СПО_учреждений",
        "челВысш": "Обучающиеся_в_ВУЗах",
        "принятоЧелВысш": "Принято_в_ВУЗы",
        "выпущеноЧелВысш": "Выпущено_из_ВУЗов"
...
if __name__ == "__main__":
    ...
    cols = [
        ...
        "Совершивших_преступления_работников_сельского_хозяйства",
    ...
    with st.sidebar:
        st.title("Районы алатайского края")
        ...
        st.subheader("Выбрать район или все районы:")
        all_states = st.checkbox("Все районы", False)
        locations = np.append(["Алтайский край всего"], states)
        state = st.selectbox("Район", states)
